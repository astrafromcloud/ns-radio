...
//                'program' => 'Утреннее шоу «Твоё утро!»',
                ...
                'hashtag' => '#RadioNS',
                'video_url' => '<iframe src="https://vk.com/video_ext.php?oid=-21723674&id=456239074&hd=1" className="w-full h-[58vh] sm:h-[60vh]" allow="autoplay; encrypted-media; fullscreen; picture-in-picture; screen-wake-lock;" allowFullScreen></iframe>'
            ],
            [
                'name' => 'Алена Малышева',
//                'program' => 'Утреннее шоу «Твоё утро!»',
