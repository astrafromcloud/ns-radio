        ...
        return [
            ...
            'today' => Tab::make(__("radio-content.tracks.labels.tabs.today"))
                ...
                ->badge(fn() => cache()->remember(
                    "tracks_resource_tab_today",
                    now()->addMinute(),
                    fn() => Track::whereDate('created_at', Carbon::today())->count()
                )),
            ...
            'yesterday' => Tab::make(__("radio-content.tracks.labels.tabs.yesterday"))
                ...
                ->badge(fn() => cache()->remember(
                    "tracks_resource_tab_yesterday",
                    now()->addMinute(),
                    fn() => Track::whereDate('created_at', Carbon::yesterday())->count()
                )),
            ...
            'this_week' => Tab::make(__("radio-content.tracks.labels.tabs.this_week"))
                ...
                ->badge(fn() => cache()->remember(
                    "tracks_resource_tab_last_week",
                    now()->addMinute(),
                    fn() => Track::whereBetween('created_at', [
                        Carbon::now()->startOfWeek(),
                        Carbon::now()->endOfWeek()
                    ])->count()
                )),
            ...
            'this_month' => Tab::make(__("radio-content.tracks.labels.tabs.this_month"))
                ...
                ->badge(fn() => cache()->remember(
                    "tracks_resource_tab_last_month",
                    now()->addMinute(),
                    fn() => Track::whereMonth('created_at', Carbon::now()->month)
                        ->whereYear('created_at', Carbon::now()->year)
                        ->count()
                )),
            ...
            'this_year' => Tab::make(__("radio-content.tracks.labels.tabs.this_year"))
                ...
                ->badge(fn() => cache()->remember(
                    "tracks_resource_tab_last_year",
                    now()->addMinute(),
                    fn() => Track::whereYear('created_at', Carbon::now()->year)->count()
                )),
        ];
    }
}
